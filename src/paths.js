...
const usernamePath = "form > div.ant-row.ant-form-item.base-form-item-platformId > div > div > span > span > input"
const passwordPath = "form > div.ant-row.ant-form-item.base-form-item-passwd > div > div > span > span > input"
const confirmPasswordPath = "form > div.ant-row.ant-form-item.base-form-item-passwdConfirm > div > div > span > span > input"
const completeNamePath = "form > div.ant-row.ant-form-item.base-form-item-realName > div > div > span > span > input"
